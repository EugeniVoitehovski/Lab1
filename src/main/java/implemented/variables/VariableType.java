...
public enum VariableType {
    ...
    INT("int", "int", (ctx, visitor) -> {
        return ((setCompilerParser.Assign_varContext)ctx).digit_expression().accept(visitor);
    }),
    ELEMENT("element", "Element", (ctx, visitor) -> {
        return ((setCompilerParser.Assign_varContext)ctx).intialize_element().accept(visitor);
    }),
    SET("set", "Set", (ctx, visitor) -> {
        return ((setCompilerParser.Assign_setContext)ctx).intialize_set().accept(visitor);
    }),;
